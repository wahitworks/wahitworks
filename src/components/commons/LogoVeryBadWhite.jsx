  ...
  return (
    ...
    >
      ...
      <g id="Layer_5" data-name="Layer 5">
        <path className="cls-very-bad-white-1" d="M231.06,321.93s24,21,66,32,65,9,65,9L362,363c1.48-.22,19.77-2.67,32,11,6.75,7.55,12.32,20.76,7,33-.65,1.5-5.6,12.41-17,15-11,2.51-23.57-3.81-30-16" transform="translate(-26.87 -81.69)"/>
      </g>
      <g id="Layer_8" data-name="Layer 8">
        <path className="cls-very-bad-white-1" d="M252,366c11.33,4.88,21.1,9.31,29,13,11.24,5.24,15.2,7.33,19,12,1.57,1.93,10.3,12.67,6,23a16.79,16.79,0,0,1-12,10,17.32,17.32,0,0,1-17-7" transform="translate(-26.87 -81.69)"/>
      </g>
      <g id="Layer_9" data-name="Layer 9">
        <path className="cls-very-bad-white-1" d="M278,319s32,17,69,14c14.13-1.15,36.51-2.91,51.73-19.49C402.61,309.3,409.6,301.25,409,290c-.72-13.53-11.91-21.27-13-22s-13.56-8.76-27-3a26.09,26.09,0,0,0-14,14c-4.15,10.36.28,19.56,1,21" transform="translate(-26.87 -81.69)"/>
      </g>
      <g id="Layer_10" data-name="Layer 10">
        <path className="cls-very-bad-white-1" d="M416,340s12,3,17,10" transform="translate(-26.87 -81.69)"/>
      </g>
      <g id="Layer_11" data-name="Layer 11">
        <path className="cls-very-bad-white-1" d="M392,198s-4-53,41-65C433,133,439,186,392,198Z" transform="translate(-26.87 -81.69)"/>
      </g>
      <g id="Layer_12" data-name="Layer 12">
        <path className="cls-very-bad-white-1" d="M477,187s-47,8-59,56C418,243,474,239,477,187Z" transform="translate(-26.87 -81.69)"/>
      </g>
      <g id="Layer_13" data-name="Layer 13">
        <circle className="cls-very-bad-white-2" cx="418.63" cy="192.81" r="1.5"/>
      </g>
      <g id="Layer_14" data-name="Layer 14">
        <circle className="cls-very-bad-white-2" cx="334.63" cy="69.81" r="2.5"/>
      </g>
      <g id="Layer_15" data-name="Layer 15">
        <circle className="cls-very-bad-white-2" cx="309.63" cy="26.81" r="7.5"/>
      </g>
      <g id="Layer_16" data-name="Layer 16">
        <circle className="cls-very-bad-white-2" cx="187.63" cy="303.81" r="6.5"/>
      </g>
    </svg>
  )
};
