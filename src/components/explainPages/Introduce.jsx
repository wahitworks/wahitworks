    ...
    >
      <div className="introduce-container">
        ...
        <div className="introduce-logo-container introduce-logo-flex">
          ...
          <div
            className="introduce-logo-title-forflex"
            style={{ backgroundImage: `url(${logoTitle})` }}
          ></div>
        </div>
        <p className="introduce-font-bold introduce-font-line">
          <span className="introduce-color-persnalblue">
            대구의 실시간 대기정보 서비스
          </span>
          를<br /> 제공하는{" "}
          <span className="introduce-color-persnalblue">대구맑음</span>입니다!
          <br />
          <br />
          대구의 맑은 공기와 함께
          <br /> 이용자 맞춤 서비스를 제공하며
          <br /> 건강한 하루를 보내기를 바라는 마음을 담았습니다.
        </p>
        ...
        <div className="introduce-font-bold introduce-font-line">
          <p>
            자주 가는 곳을 즐겨찾고,
            <br /> 원하는 정보만 카드로 채워보세요.
            <br />
            <br /> 직접 카드를 편집하여
            <br /> 여러분들만의 맞춤 앱을 만들어 보세요!
          </p>
        </div>
      </div>
    </motion.div>
