    ...
    <div className='app-wrapper'>
      <AnimatePresence>
        { menuFlg &&
          <>
            {/* 불투명 배경 */}
            <motion.div className="header-Menu-background" onClick={() => handleMenuClose()}
                initial={{ 
                  opacity: 0,
            ...
            {/* 실제 영역 */}
            <motion.div className="header-Menu-container" onClick={(e) => e.stopPropagation()}
                initial={{ 
                  opacity: 0,
                  filter: "blur(10px)",
                  x: 20
            ...
            >
              <div className="header-Menu-container-top">
                ...
                <div className="header-Menu-off" onClick={() => handleMenuClose()}>✕</div>
              </div>
