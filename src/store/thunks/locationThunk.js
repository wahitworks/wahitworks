...
import { findNearestStation } from "../../utils/geoUtil";
  ...
  async(_, { rejectWithValue }) => {
    try {
      ...
      if(navigator.geolocation) {
        ...
        // 2. 카카오 SDK 사용해서 현재 위도&경도 주소 가져오기 (index.html에 스크립트 로드 필요)
        ...
        console.log('측정서 찾기 완료 :', nearestStation);
